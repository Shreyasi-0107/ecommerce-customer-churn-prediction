...
- 📈 View model performance and validation results
...
The system identifies customers who are likely to churn and provides insights into **why** they are at risk and **what actions a business can take** to improve retention.
